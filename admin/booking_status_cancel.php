...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cancelId'])) {
    $cancelBooking = $_POST['cancelId'];

    $stmt = mysqli_prepare($conn, "UPDATE booking SET Status='Cancel' WHERE BookingNumber=?");
    mysqli_stmt_bind_param($stmt, "i", $cancelBooking);
...
$sql = "SELECT * FROM booking where Status like 'Cancel'";
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            echo "<tr>
                                                                    ...
                                                                    <td>
                                                                        <form method='GET' action='bookingDetail.php' style='display:inline'>
